...
<?php $__env->startSection('content'); ?>
    <section class="form-section">
        <form class="digiuth_form" id="student-register" method="post" action="<?php echo e(route('register.student')); ?>">
            ...
            <?php echo csrf_field(); ?>
            <?php if(\Illuminate\Support\Facades\Lang::has('third.login')): ?>
                <div class="login-btn">
            ...
            <div class="form-group">
                <?php if(\Illuminate\Support\Facades\Lang::has('third.your_email')): ?>
                    ...
                    <label for="email"><?php echo e(__('third.your_email')); ?><span>*</span></label>
                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <?php endif; ?>
                <input class="form-control" aria-describedby="emailHelp" placeholder="<?php echo e(__('third.fullname')); ?>"
                       type="text"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <?php if(\Illuminate\Support\Facades\Lang::has('third.student_username')): ?>
                    <label for="userName"><?php echo e(__('third.student_username')); ?><span>*</span></label>
                <?php endif; ?>
                <input class="form-control" aria-describedby="emailHelp" placeholder="<?php echo e(__('third.student_username')); ?>"
                       type="text"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <?php if(\Illuminate\Support\Facades\Lang::has('third.student_password')): ?>
                    <label for="password"><?php echo e(__('third.student_password')); ?><span>*</span></label>
                <?php endif; ?>
                <input class="form-control" type="password" name="password" id="password"
                       placeholder="<?php echo e(__('third.student_password')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <?php if(\Illuminate\Support\Facades\Lang::has('third.student_repassword')): ?>
                    <label for="repassword"><?php echo e(__('third.student_repassword')); ?><span>*</span></label>
                <?php endif; ?>
                <input class="form-control input2" type="password" name="password_confirmation" id="repassword"
                       placeholder="<?php echo e(__('third.student_repassword')); ?>">
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/resources/views/student.blade.php ENDPATH**/ ?>