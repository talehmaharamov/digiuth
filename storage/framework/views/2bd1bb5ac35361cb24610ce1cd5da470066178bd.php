                    ...
                    <div class="col-xl-8 px-0 col-lg-8">
                        <div class="main-menu text-right text-xl-right">
                            <nav id="mobile-menu" style="display: block;">
                                <ul>
                                    <li class="sub <?php if(request()->url() === url('/')): ?> active <?php endif; ?>">
                                    ...
                                    <?php if(auth()->guard()->check()): ?>
                                        <li class="sub">
                                            <a href="/"
                                               onclick="return false;"><?php echo e(\Str::limit(auth()->user()->fullname, 15)); ?> </a>
                                            <ul>
                                    ...
                                    <?php else: ?>
                                        <li class="sub">
                                            <a href="#" onclick="return false;"><?php echo e(__('header.personal_cabinet')); ?></a>
                                            <ul>
                                                <li>
...
<?php /**PATH /var/www/laravel/resources/views/partials/header.blade.php ENDPATH**/ ?>