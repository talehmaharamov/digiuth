                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"
                                        aria-current="page"><?php echo e(__('header.trainers')); ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <a href="<?php echo e(url('/trainers/' . $team->id . '-' . slug($team->fullname))); ?>">
                    <div class="single-team text-center mb-30 ">
                        <div class="team-thumb">
                            <div class="brd">
                                <img style="height:225px;object-fit:cover" src="<?php echo e(asset('uploads/' . $team->image)); ?>" alt="img">
                            </div>
                        </div>
                        <div class="team-info">
                            <h4>
                                <a href="<?php echo e(url('/trainers/' . $team->id . '-' . slug($team->fullname))); ?>"><?php echo e($team->fullname); ?></a>
                            </h4>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/resources/views/trainers/all.blade.php ENDPATH**/ ?>