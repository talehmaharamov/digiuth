                    ...
                    <?php if($event->getOriginal('title') !== '' || $event->getOriginal('title')  !== null): ?>
                        <div class="col-lg-6 col-md-12">
                            <div class="eventes-box">
                                ...
                                <div class="text">
                                    <h5><a href="/events/<?php echo e($event->id); ?>-<?php echo e(slug($event->title)); ?>"><?php echo e($event->title); ?></a>
                                    </h5>
                                    <ul>
                                        <li><i class="fal fa-clock"></i> <?php echo e($event->start_date->format('H:i')); ?> </li>
                                        <li><i class="icon fal fa-map-marker-check"></i> <?php echo e($event->organizer); ?></li>
                                    </ul>
                                    <p style="">
