    ...
    <section class="form-section">
        <form class="digiuth_form pt-80" id="forgot_password" action="<?php echo e(route('forgot.password')); ?>" method="POST">
            ...
            <?php if(\Illuminate\Support\Facades\Lang::has('third.submit')): ?>
                <div class="form-btns">
                    <button type="submit" class="btn-c mt-1"><?php echo e(__('third.submit')); ?></button>
                </div>
            <?php endif; ?>
        </form>
    </section>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/resources/views/forgot-password.blade.php ENDPATH**/ ?>