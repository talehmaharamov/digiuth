...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="<?php echo e(asset('vendor/nova/app.css')); ?>">
...
<body class="min-w-site bg-40 text-90 font-medium min-h-full">
    ...
    <!-- Scripts -->
    <script src="<?php echo e(asset('vendor/nova/manifest.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/nova/vendor.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/nova/app.js')); ?>"></script>
...
<?php /**PATH /var/www/laravel/vendor/laravel/nova/src/../resources/views/layout.blade.php ENDPATH**/ ?>