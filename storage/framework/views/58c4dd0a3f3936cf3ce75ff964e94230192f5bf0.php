                ...
                <div class="course-box">
                    <div class="course-video">
                        <div class="video-player">
                            <video id="video" data-v-12f6ef31="" controls="controls" controlslist="nodownload" autoplay
                                   class="block">
                                <source type="video/mp4" src="<?php echo e(\Storage::disk('bunnycdn')->url($episode->video)); ?>">
                            </video>
                                            ...
                                            <div class="info">
                                                <ul>
                                                    <li>
                                                        ...
                                                        <?php endif; ?>
                                                        <span><?php echo e($course->user->fullname); ?></span>
                                                    </li>
                                                    <li>
                                        ...
                                        <ul class="comment_block">
                                            ...
                                            <li class="new_comment">
                                                ...
                                                <div class="comment_body">
                                                    <p>
                                                        <span><?php echo e($item->user->fullname); ?></span> <?php echo e($item->comment); ?>
                        ...
                        <div class="accordion-box">
                            ...
                            <div class="accordion-item active-accordion">
                                <label for="panel-1" class="accordion-label">
                                    ...
                                    <span class="section-name"><?php echo e($sections->title); ?></span>
                                </label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/resources/views/courses/single.blade.php ENDPATH**/ ?>