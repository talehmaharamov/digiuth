...
<section class="form-section">
    <form class="digiuth_form pt-80" id="digiuth_login" method="post" action="<?php echo e(route('post.login')); ?>">
        ...
        <div class="form-group">
            ...
            <?php endif; ?>
            <input class="form-control" type="text" name="email" id="email" placeholder="<?php echo e(__('third.email_or_username')); ?>">
        </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="login-form-footer pt-15">
            ...
            <a href="<?php echo e(route('login.teacher')); ?>"><?php echo e(__('third.register_as_teacher')); ?></a>
            <?php endif; ?>
            <?php if(\Illuminate\Support\Facades\Lang::has('third.register_as_student')): ?>
            <a href="<?php echo e(route('login.student')); ?>"><?php echo e(__('third.register_as_student')); ?></a>
            <?php endif; ?>
            <?php if(\Illuminate\Support\Facades\Lang::has('third.forgot_password')): ?>
            <a href="<?php echo e(route('forgot.password')); ?>"><?php echo e(__('third.forgot_password')); ?></a>
            <?php endif; ?>
        </div>
    </form>
</section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/resources/views/login.blade.php ENDPATH**/ ?>