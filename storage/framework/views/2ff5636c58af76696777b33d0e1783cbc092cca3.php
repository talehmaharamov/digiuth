            ...
            <div class="col-sm-12 col-md-12 col-lg-4">
                <aside class="sidebar-widget">
                    ...
                    <section id="categories-1" class="widget widget_categories">
                        <?php if(\Illuminate\Support\Facades\Lang::has('third.categories')): ?>
                        <h2 class="widget-title"><?php echo e(__('third.categories')); ?></h2>
                        <?php else: ?>
                        <h2></h2>
                        <?php endif; ?>
                        <ul>
                            ...
                            <li class="cat-item cat-item-16">
                                <a href="<?php echo e(url('/news/category/' . $category->id . '-' . slug($category->title))); ?>"><?php echo e($category->title); ?></a>
                            </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/resources/views/news/all.blade.php ENDPATH**/ ?>