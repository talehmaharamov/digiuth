<?php $__env->startSection('title', $team->fullname . ' -'); ?>
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="breadcrumb-wrap text-left">
                    <div class="breadcrumb-title">
                        <h2><?php echo e($team->fullname); ?></h2>
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <?php endif; ?>
                                    <li class="breadcrumb-item active" aria-current="page"><?php echo e($team->fullname); ?></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="row intructor-row">
            <div class="col-lg-8 col-md-7 col-sm-12">
                <div class="instructor-info">
                    <h2><b><?php echo e($team->fullname); ?></b></h2>
                ...
                <div class="instructor-review">
                    <div class="total-students">
                        <?php if(\Illuminate\Support\Facades\Lang::has('team_page.students')): ?>
                        <p><b><?php echo e(__('team_page.students')); ?></b></p>
                        <?php endif; ?>
                        <span><?php echo e($students); ?></span>
                    </div>
                    <div class="total-review">
                        <?php if(\Illuminate\Support\Facades\Lang::has('team_page.rating')): ?>
                        <p><b><?php echo e(__('team_page.rating')); ?></b></p>
                        <?php endif; ?>
            ...
            <div class="col-lg-4 col-md-5 col-sm-6">
                <div class="single-team text-center mb-30 ">
                    <div class="team-thumb">
                        <div class="brd">
                            <img src="<?php echo e(asset('uploads/' . $team->image)); ?>" alt="<?php echo e($team->fullname); ?>">
                        </div>
                    </div>
                    <div class="team-info">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/resources/views/trainers/single.blade.php ENDPATH**/ ?>