...
<section id="certificate_item" class="certificate_item_area fix pt-120 pb-120">
    <div class="certificate_download">
        <span class="text"><?php echo e(__('third.upload')); ?>:</span>
        <button id="btn_convert1" type="button">JPEG</button>
        <span><?php echo e(__('third.or')); ?></span>
                    ...
                    <div class="item">
                        ...
                        <div class="card_footer">
                            <div class="certificated_time">
                                ...
                                <?php if(\Illuminate\Support\Facades\Lang::has('third.date')): ?>
                                <p class="text"><?php echo e(__('third.date')); ?></p>
                                <?php else: ?>
                            ...
                            <div class="signature">
                                ...
                                <?php if(\Illuminate\Support\Facades\Lang::has('third.signature')): ?>
                                <p class="text"><?php echo e(__('third.signature')); ?></p>
                                <?php else: ?>
                                    <p class="text"></p>
                                <?php endif; ?>
                            </div>
...
<?php /**PATH /var/www/laravel/resources/views/certificate.blade.php ENDPATH**/ ?>