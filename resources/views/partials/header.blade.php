                    ...
                    <div class="col-xl-8 px-0 col-lg-8">
                        <div class="main-menu text-right text-xl-right">
                            <nav id="mobile-menu" style="display: block;">
                                <ul>
                                    <li class="sub @if(request()->url() === url('/')) active @endif">
                                    ...
                                    @auth
                                        <li class="sub">
                                            <a href="/"
                                               onclick="return false;">{{ \Str::limit(auth()->user()->fullname, 15) }} </a>
                                            <ul>
                                    ...
                                    @else
                                        <li class="sub">
                                            <a href="#" onclick="return false;">{{ __('header.personal_cabinet') }}</a>
                                            <ul>
                                                <li>
