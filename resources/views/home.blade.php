            ...
            <div class="row align-items-center">
                <div class="col-lg-4 col-md-12">
                    ...
                    {{--<div class="slider-btn mt-10">
                        <a class="btn ss-btn" data-animation="fadeInRight" data-delay=".8s" href="services.html">View All Services</a>
                    </div>--}}
                </div>
                <div class="col-lg-8 col-md-12">
                    <div class="row">
                        @foreach($categories as $key => $category)
                            ...
                            {{--                            @if($category->getOriginal('title') != null && $category->getOriginal('title') !='' )--}}
                        ...
                        <a href="{{ url('/trainers/' . $team->id . '-' . slug($team->fullname)) }}">
                            <div class="single-team text-center mb-30 ">
                                <div class="team-thumb">
                                    <div class="brd">
                                        <img style="height:225px;object-fit:cover;" src="{{ asset('uploads/' . $team->image) }}" alt="img">
                                    </div>
                                </div>
                                <div class="team-info">
                                    <h4>
                                        <a href="{{ url('/trainers/' . $team->id . '-' . slug($team->fullname)) }}">{{ $team->fullname }}</a>
                                    </h4>
                    ...
                    @if($event->getOriginal('title') !== '' || $event->getOriginal('title')  !== null)
                        <div class="col-lg-6 col-md-12">
                            <div class="eventes-box">
                                ...
                                <div class="text">
                                    <h5><a href="/events/{{$event->id}}-{{slug($event->title)}}">{{ $event->title }}</a>
                                    </h5>
                                    <ul>
                                        <li><i class="fal fa-clock"></i> {{ $event->start_date->format('H:i') }} </li>
                                        <li><i class="icon fal fa-map-marker-check"></i> {{ $event->organizer }}</li>
                                    </ul>
                                    <p style="">
                                        {{ $event->content }}
                                    </p>
